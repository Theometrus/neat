    ...
    while running:
        ...
        for i in pop.networks:
            for j in i.genome.nodes:
                pg.draw.circle(surface=screen, center=(j.x * 700 + 10, j.y * 100 + 100), color=(0, 0, 0), radius=23)
                pg.draw.circle(surface=screen, center=(j.x * 700 + 10, j.y * 100 + 100), color=(0, 0, 200), radius=20)
                font = pg.font.SysFont('comicsans', 20)
